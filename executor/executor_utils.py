...
IMAGE_NAME = "firjjg/coj_demo_1"

CURRENT_DIR = os.path.dirname(os.path.realpath(__file__))
TEM_BUILD_DIR = "%s/tmp/" % CURRENT_DIR
...
def build_and_run(code, lang):
    ...
    source_file_host_dir = "%s/%s" % (TEM_BUILD_DIR, source_file_parent_dir_name)
    ...
    try:
        ...
        shutil.rmtree(source_file_host_dir)  # remove folder
        return result
